namespace Essa.Framework.XamarinUtil.Util
{
    ...
    public interface ITabelaEmTextoAddColuna
    {
        ...
        ITabelaEmTextoAddColuna AddColuna(string titulo, int qtdecaracteres, TipoColunaEnum tipoColuna);
    ...
    public class TabelaEmTexto : ITabelaEmTextoAddColuna, ITabelaEmTextoAddLinha
    {
        ...
        public ITabelaEmTextoAddColuna AddColuna(string titulo, int qtdecaracteres, TipoColunaEnum tipoColuna)
        {
